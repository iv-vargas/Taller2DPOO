...
public class SandboxListas
{
    ...
    public List<Integer> getCopiaEnteros( )
    {
    	...
    	for (Iterator<Integer> iterator = listaEnteros.iterator(); iterator.hasNext();)
    	{
    		Integer siguienteNumero = iterator.next();
    		copiaEnteros.add(siguienteNumero);
    	}
    ...
    public List<String> getCopiaCadenas( )
    {
    	...
    	{
    		String siguienteCadena = iterator.next();
    		copiaCadenas.add(siguienteCadena);
    	}
    ...
    {
    	int [] resultado = new int[getCantidadEnteros()];
    ...
    {
    	if(posicion >= getCantidadEnteros()) {
    ...
    {
    	if(posicion < getCantidadEnteros() && posicion >= 0) {
    ...
    public void volverPositivos( )
    {
    	for(int i = 0; i<listaEnteros.size(); i++) {
    		...
    		if(numeroActual < 0) {
    			...
    			listaEnteros.add(i, -1*numeroActual);
    		}
    	}
    }
